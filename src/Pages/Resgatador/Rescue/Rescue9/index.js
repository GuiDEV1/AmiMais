...
import {
    ...
    id7_Name, id7_Profile, id8_Name, id8_Profile, id6_Name, id6_Profile, id10_Name, id10_Profile, id11_Name, id11_Profile,
} from '../../database';

// Define this Rescuer
const Tel = id9_Tel;
const City = id9_City;
const Rescue = id9_Rescue;
const FavOng = id9_FavOng;
const VoluntTime = id9_VoluntTime;
const Description = id9_Description;

const Name = id9_Name;
const User = id9_User;
const Banner = id9_Banner;
const Profile = id9_Profile;


export function Rescue9() {
    return (
        <>
            <Interface />
