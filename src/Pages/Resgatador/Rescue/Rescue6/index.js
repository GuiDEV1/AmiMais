...
import {
    ...
    id7_Name, id7_Profile, id8_Name, id8_Profile, id9_Name, id9_Profile, id10_Name, id10_Profile, id11_Name, id11_Profile,
} from '../../database';

// Define this Rescuer
const Tel = id6_Tel;
const City = id6_City;
const Rescue = id6_Rescue;
const FavOng = id6_FavOng;
const VoluntTime = id6_VoluntTime;
const Description = id6_Description;

const Name = id6_Name;
const User = id6_User;
const Banner = id6_Banner;
const Profile = id6_Profile;


export function Rescue6() {
    return (
        <>
            <Interface />
