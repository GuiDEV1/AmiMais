...
import {
    ...
    id7_Name, id7_Profile, id8_Name, id8_Profile, id9_Name, id9_Profile, id10_Name, id10_Profile, id6_Name, id6_Profile,
} from '../../database';

// Define this Rescuer
const Tel = id11_Tel;
const City = id11_City;
const Rescue = id11_Rescue;
const FavOng = id11_FavOng;
const VoluntTime = id11_VoluntTime;
const Description = id11_Description;

const Name = id11_Name;
const User = id11_User;
const Banner = id11_Banner;
const Profile = id11_Profile;

export function Rescue11() {
    return (
        <>
            <Interface />
