...
const Tel = id3_Tel;
const City = id3_City;
const Rescue = id3_Rescue;
const FavOng = id3_FavOng;
const VoluntTime = id3_VoluntTime;
const Description = id3_Description;

const Name = id3_Name;
const User = id3_User;
const Banner = id3_Banner;
const Profile = id3_Profile;
