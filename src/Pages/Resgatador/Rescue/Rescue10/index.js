...
import {
    ...
    id7_Name, id7_Profile, id8_Name, id8_Profile, id9_Name, id9_Profile, id6_Name, id6_Profile, id11_Name, id11_Profile,
} from '../../database';

// Define this Rescuer

const Tel = id10_Tel;
const City = id10_City;
const Rescue = id10_Rescue;
const FavOng = id10_FavOng;
const VoluntTime = id10_VoluntTime;
const Description = id10_Description;

const Name = id10_Name;
const User = id10_User;
const Banner = id10_Banner;
const Profile = id10_Profile;
