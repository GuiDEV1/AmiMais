...
import {
    ...
    id6_Name, id6_Profile, id8_Name, id8_Profile, id9_Name, id9_Profile, id10_Name, id10_Profile, id11_Name, id11_Profile,
} from '../../database';

// Define this Rescuer
const Tel = id7_Tel;
const City = id7_City;
const Rescue = id7_Rescue;
const FavOng = id7_FavOng;
const VoluntTime = id7_VoluntTime;
const Description = id7_Description;

const Name = id7_Name;
const User = id7_User;
const Banner = id7_Banner;
const Profile = id7_Profile;


export function Rescue7() {
    return (
        <>
            <Interface />
