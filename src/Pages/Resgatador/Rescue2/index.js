...
const Name = "Alice de Souza";
const User = "@AlicedeSouza";
const Banner = "id2_banner"
const Profile = 'https://cdn.discordapp.com/attachments/1026668645033709692/1044261001782116492/Alice_de_Souza.jpg';

export function Rescue2() {
    return (
        <>
            <Interface />
            <div id="Resgatador">
                ...
                <SideBar />
                    <div className='rescueComponent'>
                        <section className={`rescueContainer`}>
                            <div className={`Resg-Header ${Banner}`}>  {/* Trocar Background no CSS*/}
                                <ResgatadorHeader />
                            </div>
                        </section>
                        <section className='flex'>
                            ...
                            <div className='assd'>
                                <ResgatadorBody
                                    ...
                                    BANNER={Banner}
                                    FAVORITE_ONG={FavOng}
                                    RESCUES_TOTAL={Rescue}
                                    PROFILE={Profile}
                                    RESCUE_TIME={VoluntTime}
