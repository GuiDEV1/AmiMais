...
import './style.css';
import pgato from './Imagens/primeiroGato.png';
        ...
        <div id="Curiosidade">
         <section className='titulo'>
            <div className='curiosidades'>
               <p><span className='laranja'>Curios</span><span className='turquesa'>idades</span></p>
            </div>
         </section>

         <div className='Pcuriosidades'>
            <div className='a'>
               <h2 className='laranja'>A castração é a <span className='turquesa'>melhor solução?</span></h2>
               <p>
         ...
         <div className="tcuriosidades">
            <div className='conteudo-tcuriosidades'>
               <h2 className='laranja'><strong>Cães e <span className='turquesa'>gatos</span></strong></h2>
               <p>
